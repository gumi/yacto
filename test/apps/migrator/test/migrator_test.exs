defmodule MigratorTest do
  ...
  test "プライマリキーを削除することができる" do
    Mix.Task.rerun("ecto.drop")
    Mix.Task.rerun("ecto.create")

    {:ok, _} = Migrator.Repo1.start_link()
    v1 = [
      {Migrator.AutogeneratePrimaryKey, %Yacto.Migration.Structure{},
       Yacto.Migration.Structure.from_schema(Migrator.AutogeneratePrimaryKey)}
    ]

    v2 = [
      {Migrator.DeleteAutogeneratePrimaryKey, Yacto.Migration.Structure.from_schema(Migrator.AutogeneratePrimaryKey),
       Yacto.Migration.Structure.from_schema(Migrator.DeleteAutogeneratePrimaryKey)}
    ]

    source = Yacto.Migration.GenMigration.generate_source(Migrator, v1, 20_190_515_162_530, nil)
    File.write!("migration_test_1.exs", source)

    source = Yacto.Migration.GenMigration.generate_source( Migrator,
        v2,
        20_190_515_162_533,
        20_190_515_162_530
      )
  ...
  test "Autogenerated な複合プライマリキーを変更することはできない" do
    ...
    v1 = [
      {Migrator.AutogeneratePrimaryKey2, %Yacto.Migration.Structure{},
       Yacto.Migration.Structure.from_schema(Migrator.AutogeneratePrimaryKey2)}
    ]

    v2 = [
      {Migrator.DeleteAutogeneratePrimaryKey2, Yacto.Migration.Structure.from_schema(Migrator.AutogeneratePrimaryKey2),
       Yacto.Migration.Structure.from_schema(Migrator.DeleteAutogeneratePrimaryKey2)}
    ]

    source = Yacto.Migration.GenMigration.generate_source(Migrator, v1, 20_190_515_162_530, nil)
    File.write!("migration_test_1.exs", source)

    assert_raise(Yacto.Migration.GenMigration.GenMigrationError,
      ~r/AutogenerateID Primary key can not be changed/, fn ->
        Yacto.Migration.GenMigration.generate_source( Migrator,
          v2,
          20_190_515_162_533,
          20_190_515_162_530
        )
