...
defmodule Migrator.AutogeneratePrimaryKey do
  use Yacto.Schema
  ...
  schema @auto_source do
    field(:player_id, :integer, primary_key: true, autogenerated: true)
  end
end

defmodule Migrator.DeleteAutogeneratePrimaryKey do
  use Yacto.Schema
...
defmodule Migrator.AutogeneratePrimaryKey2 do
  use Yacto.Schema
  ...
  schema @auto_source do
    field(:player_id, :id, primary_key: true, autogenerate: true)
    field(:unit_id, :id, primary_key: true)
  end
end

defmodule Migrator.DeleteAutogeneratePrimaryKey2 do
  use Yacto.Schema
