defmodule Yacto.GenMigrationTest2 do
  ...
  test "foo" do
    {:created, player, 0} = Yacto.Migration.GenMigration2.generate(Yacto.GenMigrationTest.Player, nil)
    IO.puts(player)
